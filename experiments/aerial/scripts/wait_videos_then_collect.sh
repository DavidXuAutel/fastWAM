...
STATUS_FILE="${STATUS_FILE:-/tmp/aerial_eval_cache/logs/eval/b0_seen_videos.status}"
COLLECTION_SOURCE="${COLLECTION_SOURCE:-/tmp/aerial_eval_cache/data/openfly_raw/Annotation/seen_airsim16_collection_source.json}"
COLLECTION_MANIFEST="${COLLECTION_MANIFEST:-/tmp/aerial_eval_cache/logs/eval/collection_manifest.json}"
COLLECTION_OUT="${COLLECTION_OUT:-/tmp/aerial_eval_cache/data/b0_dagger_correction}"
